...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeIgnoredIfBooked() {
    // Have optional attendee who is booked all day, should be ignored. 
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeConsideredIfAvailable() {
    // Have optional attendee who has enough time for the meeting, 
    // should only return the slots when all attendees can make it 
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  public void notEnoughRoomForOptionalAttendee() {
    // Optional attendee has availability, but ignored because not available 
    // for long enough (would make time slot too small)
    //
    // Events  : |--A--|     |----A----|
    //                 |-B|
    // Day     : |---------------------|
  ...
  public void onlyAvailableOptionalAttendees() {
    // Only two optional attendees, who have enough time for the meeting
    //
    // Events  :    |-A-|     |--B--|
    // Day     : |---------------------|
    // Options : |--|   |-----|     |--|      
  ...
  @Test
  public void onlyBookedOptionalAttendees() {
    // Only two optional attendees who don't have any availability
    //
    // Events  : |----A----|
    //           |----------B----------|
    // Day     : |---------------------|
